...
import ImClient from '../../../views/general/Client/ImClient';

export default function Starter() {
  const [currentView, setCurrentView] = React.useState('starter');
  
  const handleClientAccess = () => {
    setCurrentView('client');
  };
  
  const handleNoClientAccess = () => {
    // Aquí puedes agregar la lógica para no clientes
    console.log('Acceso para no clientes');
  };
            ...
            <div className="bg-white rounded-xl shadow-xl overflow-hidden border-2 border-[#5D7166]">
              ...
              <div className="p-6 lg:p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 max-w-2xl mx-auto">
                  ...
                  {/* No Cliente Button */}
                  <button 
                    onClick={handleNoClientAccess}
                    className="bg-[#B7F2DA] hover:bg-[#8ECAB2] rounded-lg p-4 sm:p-6 border-2 border-[#8ECAB2] transition-all duration-200 hover:shadow-lg group"
                  >
                  ...
                  <button 
                    ...
                    className="bg-[#70A18E] hover:bg-[#547A6B] rounded-lg p-4 sm:p-6 border-2 border-[#547A6B] transition-all duration-200 hover:shadow-lg group"
                  >
                    <div className="flex flex-col items-center space-y-3">
