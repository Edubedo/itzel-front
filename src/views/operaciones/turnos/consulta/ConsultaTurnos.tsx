  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Turno Actual */}
        <div className="bg-[#D3EEE3] rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-6">
            {turnoActual ? (
              <div className="text-center">
                <div className="text-6xl font-bold text-[#3A554B] mb-4">
                ...
                <div className="flex justify-center mt-6">
                  <CheckCircle className="w-12 h-12 text-[#3A554B]" />
                </div>
              </div>
            ) : (
                ...
                {turnosSiguientes.map((turno, index) => (
                  <div 
                    ...
                    className={`p-4 hover:bg-gray-50 transition-colors ${
                      index === 0 ? 'bg-[#D3EEE3] border-l-4 border-[#70A18E]' : ''
                    }`}
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className={`text-2xl font-bold ${
                          index === 0 ? 'text-[#3A554B]' : 'text-[#224236]'
                        }`}>
      ...
      <div className="mt-6 bg-[#D3EEE3] rounded-xl shadow-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          ...
          <div>
            ...
            <span className="text-[#224236] font-medium">Operativo</span>
          </div>
        </div>
      </div>
    </div>
