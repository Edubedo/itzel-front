...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | ITZEL - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for ITZEL - React.js Tailwind CSS Admin Dashboard Template"
      />
