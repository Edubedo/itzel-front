...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | ITZEL - React.js Admin Dashboard Template"
        description="This is React.js Videos page for ITZEL - React.js Tailwind CSS Admin Dashboard Template"
      />
