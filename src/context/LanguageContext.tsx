...
const translations = {
  es: {
    ...
    "services.newService": "para Servicio Nuevo",
    ...
    "clients.contractType": "Tipo de Contrato",
  ...
  en: {
    ...
    "services.newService": "for New Service",
    ...
    "configuration.successTitle": "Successful operation!",
    ...
    "configuration.systemActiveMessage": "The system is currently active and running",
